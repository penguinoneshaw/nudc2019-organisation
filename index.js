...
let [
    ...
    invoice_template_promise,
    invoice_list_template_promise,
    index_promise,
    university_index_promise,
    event_index_promise,
    competitor_list_template
] =
    [
        "template", "invoice", "invoice_list", "index", "university_index", "event_index", "competitor_list"
    ].map(async (templateName) => {
        const file = await fs.readFile(`handlebars_templates/${templateName}.hbs`);
